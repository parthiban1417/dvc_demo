...
def load_data(data_url: str) -> pd.dataframe:
    try:
        ...
        Print(f'Error: An unexpecteed error occured while loading the data.')
        print(e)
        raise
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    try:
        ...
        print(f'Error: An unexpected error occured while preprocessing the data.')
        print(e)
        raise
...
def main():
    try:
        ...
        print(f'Error: {e}')
        print('Faled to cmplete the ingestion process.')
